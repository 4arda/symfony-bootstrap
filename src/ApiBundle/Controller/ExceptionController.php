...
class ExceptionController implements ContainerAwareInterface
{
    ...
    protected function createExceptionWrapper(array $parameters)
    {
        ...
        $parameters = $exceptionWrapperHandler->wrap($parameters);
    ...
    public function showAction(Request $request, $exception, DebugLoggerInterface $logger = null)
    {
        ...
        try {
            ...
            if (!is_array($parameters)) {
                $parameters = new \ApiBundle\Util\ExceptionWrapper([
                    'status_code' => $parameters->getCode(),
                    'message' => $parameters->getMessage(),
                    'errors' => $parameters->getErrors(),
                    'code' => $exception instanceof HttpException ? $exception->getCode() : 0
                ]);
            }
